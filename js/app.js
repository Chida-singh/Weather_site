...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensure debounce and weatherBackgrounds are available
    if (typeof debounce !== 'function') {
        console.error('Debounce function is not defined');
        return;
    }
    
    if (typeof weatherBackgrounds !== 'object') {
        console.error('Weather backgrounds are not defined');
        return;
    }
